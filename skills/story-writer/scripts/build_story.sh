...
# Usage (depuis la racine NewBooks) :
#   bash skills/story-writer/scripts/build_story.sh <story_base_name> <generator_script.js>
...
echo "── Step 3a: Language + autoHyphenation (FR)"
